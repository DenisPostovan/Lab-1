...
int main() {
	...
	Texture t;
	t.loadFromFile("C:/Users/Denis/Desktop/Paint/title.png");
	Sprite plat(t);

	Texture yw;
	yw.loadFromFile("C:/Users/Denis/Desktop/Paint/youwin.png");
	Sprite youwin(yw);
	youwin.setPosition(100, 210);

	Texture yl;
	yl.loadFromFile("C:/Users/Denis/Desktop/Paint/youlose.png");
	Sprite youlose(yl);
